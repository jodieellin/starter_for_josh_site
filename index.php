<?php get_header();?>   <!--  Tells WordPress to include header.php --><Section class="container-fluid aboutbg text-center">
        <div class="container">
            ...
            <p class="about-text">My name is josh Whitkin. I’m a professional with more than 7 years of industry
                ...
                combination of technology and creativity, and how multiple disciplines come together to create
                an
                interactive experience. Whether I'm designing for puzzle games, 2D platformers or 3D
                environments.
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="article-p">STS has never been shy of seeking new terrains of investigation. More
                        and more
                        STS scholars are
                        starting to explore and intervene in the arts. This object of study brings new
                        challenges and
                        opportunities that we want to explore in this session. We would like to gather first of
                        all
                ...
                <div class="col-md-4">
                    ...
                    <p class="article-p">STS has never been shy of seeking new terrains of investigation. More
                        ...
                        all
                        simply new kinds of knowledge arising from STS study of the arts.
                    </p><a class="readmore" href="#">CONTINUE READING</a>
                </div>
